...
class FeatureMapVis_siamese(BaseActivationMapping):
    def __init__(self, net, use_gpu=True):
        super(FeatureMapVis_siamese, self).__init__(net, use_gpu)
    ...
    def run(self, data, feature_index=1, target=None, activate_fun='softmax'):
